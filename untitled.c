...
unsigned char gps_getloc[] = {"AT+CGPSOUT=32"};
unsigned char loc[100] = {""};
unsigned char Lati[16], Longi[16];
int writeLoc, locEndInd, endLati, endLongi;
